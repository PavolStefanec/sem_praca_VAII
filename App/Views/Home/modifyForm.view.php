...
<div class="container">
    <div class="form-block">
        <div class="col-sm-4 offset-sm-4">
            ...
            <form method="post" action="?c=home&a=modifyBand">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="bio" id="exampleFormControlInput2">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput2" class="form-label">Members</label>
                    <input type="text" class="form-control" name="members" id="exampleFormControlInput2">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput2" class="form-label">DiscoGraphy</label>
                    <input type="text" class="form-control" name="disco" id="exampleFormControlInput2">
                </div>
                <div class="mb-3">
